...
if (isset($_POST['nisn'])) {
    ...
    $query = mysqli_query($koneksi, "INSERT INTO siswa(nisn,nis,nama_siswa,tempat_lahir,tanggal_lahir,jenis_kelamin,id_kelas) VALUES('$nisn','$nis','$nama','$tempat_lahir','$tanggal_lahir','$jenis_kelamin','$id_kelas')");
